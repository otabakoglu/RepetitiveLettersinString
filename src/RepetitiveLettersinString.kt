fun main() {
    ...
    println("abbcccaaeeeeb bfffffca ccab" == calc("abbcccaaeeeeb bfffffca ccab", 9))
    println("abbcccaaeeeeb b*****ca ccab" == calc("abbcccaaeeeeb bfffffca ccab", 5))
    println("abbcccaa****b b*****ca ccab" == calc("abbcccaaeeeeb bfffffca ccab", 4))
    println("abb***aa****b b*****ca ccab" == calc("abbcccaaeeeeb bfffffca ccab", 3))
    println("a***********b b*****ca **ab" == calc("abbcccaaeeeeb bfffffca ccab", 2))
...
fun calc(data: String, n: Int): String{
    ...
    // karakter aynı ise sayaci arttır karakter farkli ise sayaca bak.
